...
# ============================================================================
# SECTION 1: IMPORTS
# What to say: "These are all the libraries I need. CSV for file handling, 
...
# ============================================================================
# SECTION 2: CONSTANTS
# What to say: "This is the HTML page City Hive provided. My script fetches 
...
# What to say: "This is my main class. When it starts, it connects to AWS S3 
...
class InventoryProcessor:
    ...
    # What to say: "This method fetches the HTML page from Bitbucket and 
    ...
    # What to say: "This makes the actual GET request to S3 using boto3. 
    ...
    # What to say: "This parses the CSV content from memory using StringIO - 
    ...
    # What to say: "This calculates the new price. First I compute margin as 
    ...
    # What to say: "This handles the UPC requirement. If the UPC has only 
    ...
    # What to say: "This creates the tags. If the ItemNum appears multiple 
    ...
    # What to say: "This is the core method that applies all business rules 
    ...
    # What to say: "This runs the entire pipeline - parse the CSV, transform 
    ...
    # What to say: "This saves the transformed records to a CSV file. 
...
# What to say: "This class handles communication with the Rails API. 
...
"This is standard Python - it calls the main function when the script is run directly."
# ============================================================================
